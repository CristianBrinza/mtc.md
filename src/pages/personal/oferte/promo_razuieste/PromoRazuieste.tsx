  ...
  return (
    <>
      ...
      <div className={styles.promorazuieste}>
        ...
        <div>
        <span className={styles.wincard_title_text}>  {t('promorazuieste.intro.part1')}
          {'  '}
          ...
          {t('promorazuieste.intro.part2_3')}</span>
      ...
      <div className={styles.promorazuieste}>
        ...
        <div style={{display:"none"}} className={styles.win}>
          ...
          <div
            ...
            style={{ background: 'linear-gradient(135deg, #ffca3b, #ffeaa2)', color: '#fff', }}
          >
            <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M17.6047 1.21528C17.9784 0.99347 18.4434 0.99347 18.8172 1.21528L25.7359 5.32179L32.7517 9.26037C33.1306 9.47311 33.3631 9.87583 33.3579 10.3104L33.2609 18.3555L33.3579 26.4006C33.3631 26.8351 33.1306 27.2378 32.7517 27.4506L25.7359 31.3892L18.8172 35.4957C18.4434 35.7175 17.9784 35.7175 17.6047 35.4957L10.6859 31.3892L3.67021 27.4506C3.29126 27.2378 3.05875 26.8351 3.06399 26.4006L3.16094 18.3555L3.06399 10.3104C3.05875 9.87583 3.29126 9.47311 3.67021 9.26037L10.6859 5.32179L17.6047 1.21528Z" fill="#F8CFAD"/>
              <path d="M25.7383 5.32324L32.7539 9.26172C33.1327 9.4745 33.3646 9.87709 33.3594 10.3115L33.2627 18.3564L33.3594 26.4014C33.3646 26.8359 33.1328 27.2394 32.7539 27.4521L25.7383 31.3906L18.8193 35.4971C18.4456 35.7189 17.9802 35.7189 17.6064 35.4971L11.1367 31.6572L23.123 3.77051L25.7383 5.32324Z" fill="#F0BD90"/>
              <path d="M17.7757 10.3794C17.9614 10.0275 18.4655 10.0275 18.6511 10.3794L20.7918 14.4367C20.8634 14.5724 20.9939 14.6672 21.1451 14.6934L25.6653 15.4755C26.0574 15.5433 26.2132 16.0227 25.9358 16.3081L22.7386 19.5977C22.6317 19.7078 22.5818 19.8612 22.6037 20.0131L23.2567 24.5537C23.3133 24.9476 22.9055 25.2439 22.5484 25.0683L18.4318 23.0441C18.2941 22.9764 18.1328 22.9764 17.9951 23.0441L13.8784 25.0683C13.5214 25.2439 13.1136 24.9476 13.1702 24.5537L13.8232 20.0131C13.8451 19.8612 13.7952 19.7078 13.6883 19.5977L10.491 16.3081C10.2137 16.0227 10.3695 15.5433 10.7616 15.4755L15.2818 14.6934C15.433 14.6672 15.5635 14.5724 15.6351 14.4367L17.7757 10.3794Z" fill="#F9F0E9"/>
            </svg>
          ...
          <div
            className={styles.wincard}
            style={{ background: 'linear-gradient(135deg, #ff5283, #ffa2ba)', color: '#fff' }}
          >
            <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M17.2492 1.21528C17.623 0.99347 18.088 0.99347 18.4617 1.21528L25.3805 5.32179L32.3962 9.26037C32.7751 9.47311 33.0077 9.87583 33.0024 10.3104L32.9055 18.3555L33.0024 26.4006C33.0077 26.8351 32.7751 27.2378 32.3962 27.4506L25.3805 31.3892L18.4617 35.4957C18.088 35.7175 17.623 35.7175 17.2492 35.4957L10.3305 31.3892L3.31474 27.4506C2.93579 27.2378 2.70328 26.8351 2.70852 26.4006L2.80547 18.3555L2.70852 10.3104C2.70328 9.87583 2.93579 9.47311 3.31474 9.26037L10.3305 5.32179L17.2492 1.21528Z" fill="#E4E6E5"/>
              <path d="M25.3857 5.32324L32.4014 9.26172C32.7803 9.47446 33.013 9.87697 33.0078 10.3115L32.9111 18.3564L33.0078 26.4014C33.013 26.8359 32.7803 27.2394 32.4014 27.4521L25.3857 31.3906L18.4668 35.4971C18.0932 35.7186 17.6284 35.7187 17.2549 35.4971L10.7812 31.6543L22.7676 3.76855L25.3857 5.32324Z" fill="#D2D2D2"/>
              <path d="M17.4164 10.3794C17.602 10.0275 18.1061 10.0275 18.2918 10.3794L20.4324 14.4367C20.504 14.5724 20.6345 14.6672 20.7857 14.6934L25.3059 15.4755C25.698 15.5433 25.8538 16.0227 25.5765 16.3081L22.3793 19.5977C22.2723 19.7078 22.2224 19.8612 22.2443 20.0131L22.8973 24.5537C22.9539 24.9476 22.5461 25.2439 22.1891 25.0683L18.0724 23.0441C17.9347 22.9764 17.7734 22.9764 17.6357 23.0441L13.5191 25.0683C13.162 25.2439 12.7542 24.9476 12.8108 24.5537L13.4638 20.0131C13.4857 19.8612 13.4358 19.7078 13.3289 19.5977L10.1317 16.3081C9.85434 16.0227 10.0101 15.5433 10.4022 15.4755L14.9224 14.6934C15.0736 14.6672 15.2041 14.5724 15.2757 14.4367L17.4164 10.3794Z" fill="#F9F0E9"/>
            </svg>
          ...
          <div
            className={styles.wincard}
            style={{ background: 'linear-gradient(135deg, #5256ff, #a6a2ff)', color: '#fff' }}
          >
            <svg width="35" height="36" viewBox="0 0 35 36" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M25.0273 5.32324L32.043 9.26172C32.4217 9.4745 32.6537 9.87709 32.6484 10.3115L32.5518 18.3564L32.6484 26.4014C32.6537 26.8359 32.4219 27.2394 32.043 27.4521L25.0273 31.3906L18.1084 35.4971C17.7347 35.7189 17.2692 35.7189 16.8955 35.4971L10.4258 31.6572L22.4121 3.77051L25.0273 5.32324Z" fill="#FFCB53"/>
              <path d="M17.0648 10.3794C17.2505 10.0275 17.7545 10.0275 17.9402 10.3794L20.0809 14.4367C20.1525 14.5724 20.283 14.6672 20.4342 14.6934L24.9544 15.4755C25.3465 15.5433 25.5022 16.0227 25.2249 16.3081L22.0277 19.5977C21.9207 19.7078 21.8709 19.8612 21.8927 20.0131L22.5457 24.5537C22.6024 24.9476 22.1946 25.2439 21.8375 25.0683L17.7209 23.0441C17.5832 22.9764 17.4218 22.9764 17.2841 23.0441L13.1675 25.0683C12.8104 25.2439 12.4026 24.9476 12.4593 24.5537L13.1123 20.0131C13.1341 19.8612 13.0843 19.7078 12.9773 19.5977L9.78011 16.3081C9.50278 16.0227 9.65853 15.5433 10.0506 15.4755L14.5708 14.6934C14.722 14.6672 14.8525 14.5724 14.9242 14.4367L17.0648 10.3794Z" fill="#F9F0E9"/>
            </svg>
