      ...
      <div className={styles.promorazuieste}>
        ...
        <div className={styles.win}>
          ...
          <div
            ...
            style={{ background: 'linear-gradient(135deg, #070F94, #050631)', color: '#fff', }}
          >
          ...
          <div
            className={styles.wincard}
            style={{ background: 'linear-gradient(135deg, #D94653, #F7B74D)', color: '#fff' }}
          >
            <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div
            className={styles.wincard}
            style={{ background: 'linear-gradient(135deg, #FF5283, #FEA2BA)', color: '#fff' }}
          >
