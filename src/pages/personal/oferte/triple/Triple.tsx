...
export default function Triple() {
  ...
  const breadcrumbItems = [
    ...
    { label: t('navbar.internet_tv_mobil') },
  ];
  ...
  const [activeMobil_1, setActiveMobil_1] = useState<number>(0);
  function calculateTotal_1(
    ...
    return base + meshVal + safeVal + telVal + tvVal + extraTV + finalmobilVal;
  }
  ...
  const [activeMobil_2, setActiveMobil_2] = useState<number>(0);
  ...
  const [activeMobil_3, setActiveMobil_3] = useState<number>(0);
  ...
  const [selectedDevice_4_4, setSelectedDevice_4_4] =
    useState<string>('1780226');
  const [activeMobil_4, setActiveMobil_4] = useState<number>(0);
  function calculateTotal_4(
    ...
    return base + safeVal + telVal + tvVal + extraTV + finalmobilVal;
  }
  ...
  const [selectedDevice_5_5, setSelectedDevice_5_5] =
    useState<string>('1780226');
  const [activeMobil_5, setActiveMobil_5] = useState<number>(0);
  ...
  const setPopup = (id: string, name: string, subname: string) => {
    if (id == '0') {
      trackEvent('triple_device_buy', `${name} ${subname}`);
    }
    ...
    setActiveBuyConfig(
      id === '1'
        ? `[${isRegio ? 'regio' : 'non-regio'}] (Internet + TV + Mobil) Triple – ${name} ${subname} (tip - ${activeTVConfig_1}, nr - ${numberTVConfig_1} tv), ${activeMesh_1 ? '+ Wi‑Fi Mesh, ' : ''}${activeSafeweb_1 ? '+ Safe‑Web, ' : ''}${activeTelephone_1 ? '+ Telefonie Fixa, ' : ''} (Oferta Back-2-School 2025)`
        : id === '2'
          ? `[${isRegio ? 'regio' : 'non-regio'}] (Internet + TV + Mobil) Triple – ${name} ${subname} (tip - ${activeTVConfig_2}, nr - ${numberTVConfig_2} tv), ${activeMesh_2 ? '+ Wi‑Fi Mesh, ' : ''}${activeSafeweb_2 ? '+ Safe‑Web, ' : ''}${activeTelephone_2 ? '+ Telefonie Fixa, ' : ''} (Oferta Back-2-School 2025)`
          : id === '3'
            ? `[${isRegio ? 'regio' : 'non-regio'}] (Internet + TV + Mobil) Triple – ${name} ${subname} (tip - ${activeTVConfig_3}, nr - ${numberTVConfig_3} tv), ${activeMesh_3 ? '+ Wi‑Fi Mesh, ' : ''}${activeSafeweb_3 ? '+ Safe‑Web, ' : ''}${activeTelephone_3 ? '+ Telefonie Fixa, ' : ''} (Oferta Back-2-School 2025)`
            : id === '4'
              ? `[${isRegio ? 'regio' : 'non-regio'}] (Internet + TV + Mobil) Triple – ${name} ${subname} (tip - ${activeTVConfig_4}, nr - ${numberTVConfig_4} tv), ${activeSafeweb_4 ? '+ Safe‑Web, ' : ''}${activeTelephone_4 ? '+ Telefonie Fixa, ' : ''} (Oferta Back-2-School 2025)`
              : id === '5'
                ? `[${isRegio ? 'regio' : 'non-regio'}] (Internet + TV + Mobil) Triple – ${name} ${subname} (tip - ${activeTVConfig_5}, nr - ${numberTVConfig_5} tv), ${activeSafeweb_5 ? '+ Safe‑Web, ' : ''}${activeTelephone_5 ? '+ Telefonie Fixa, ' : ''} (Oferta Back-2-School 2025)`
                : ''
    );
    // console.log(
      ...
      <Hero color="#F7F7F7" classname={styles.hero}>
        <div className={styles.hero_img_block}>
          <img
            ...
            src={`/images/landings/13716912${t('lang')}.webp`}
            alt={t('wifi_plus.hero.alt')}
          />
          <img
            className={styles.hero_img_tablet}
            src={`/images/landings/18716912${t('lang')}.webp`}
            alt={t('wifi_plus.hero.alt')}
          />
        </div>
      </Hero>
      ...
      {isRegio ? (
        <div className={styles.config}>
          ...
          <div
            onClick={() => {
              setActiveConfig('3');
              trackEvent('triple_select_type_gaming_set');
            }}
      ...
      <Slider {...settings} className={styles.abonaments}>
        {(activeConfig == '1' || activeConfig == '2' || !isRegio) && (
          <div className={styles.abonaments_block}>
            <div className={styles.abonaments_block_inside}>
              ...
              <div className={styles.abonaments_block_mobiles}>
                <div
                  className={`${styles.abonaments_block_mobile} ${activeMobil_1 == 1 && styles.abonaments_block_mobile_active}`}
                  onClick={() => setActiveMobil_1(v => (v === 1 ? 0 : 1))}
                >
                  Start 120
                </div>
                <div
                  className={`${styles.abonaments_block_mobile} ${activeMobil_1 == 2 && styles.abonaments_block_mobile_active}`}
                  onClick={() => setActiveMobil_1(v => (v === 2 ? 0 : 2))}
                >
                  Flex 150
                </div>
                <div
                  className={`${styles.abonaments_block_mobile} ${activeMobil_1 == 3 && styles.abonaments_block_mobile_active}`}
                  onClick={() => setActiveMobil_1(v => (v === 3 ? 0 : 3))}
                >
                  Liberty 200
                </div>
                <div
                  className={`${styles.abonaments_block_mobile} ${activeMobil_1 == 4 && styles.abonaments_block_mobile_active}`}
                  onClick={() => setActiveMobil_1(v => (v === 4 ? 0 : 4))}
                >
                  Liberty 290+
                </div>
              </div>
        ...
        {(activeConfig === '1' || activeConfig === '2') && (
          <div className={styles.abonaments_block}>
            <div className={styles.abonaments_block_inside}>
              ...
              <div className={styles.abonaments_block_mobiles}>
                <div
                  className={`${styles.abonaments_block_mobile} ${activeMobil_2 == 1 && styles.abonaments_block_mobile_active}`}
                  onClick={() => setActiveMobil_2(v => (v === 1 ? 0 : 1))}
                >
                  Start 120
                </div>
                <div
                  className={`${styles.abonaments_block_mobile} ${activeMobil_2 == 2 && styles.abonaments_block_mobile_active}`}
                  onClick={() => setActiveMobil_2(v => (v === 2 ? 0 : 2))}
                >
                  Flex 150
                </div>
                <div
                  className={`${styles.abonaments_block_mobile} ${activeMobil_2 == 3 && styles.abonaments_block_mobile_active}`}
                  onClick={() => setActiveMobil_2(v => (v === 3 ? 0 : 3))}
                >
                  Liberty 200
                </div>
                <div
                  className={`${styles.abonaments_block_mobile} ${activeMobil_2 == 4 && styles.abonaments_block_mobile_active}`}
                  onClick={() => setActiveMobil_2(v => (v === 4 ? 0 : 4))}
                >
                  Liberty 290+
                </div>
              </div>
        ...
        <div className={styles.abonaments_block}>
          <div className={styles.abonaments_block_inside}>
            ...
            <div className={styles.abonaments_block_inside_subtitle}>
              <div className={styles.abonaments_block_inside_subtitle_toggle}>
                ...
                <Toggle
                  ...
                  onChange={trackToggle('triple_mesh_toggle', setActiveMesh_3)}
                />
              </div>
              <span>
                x1 <b>Mesh Wi-Fi</b>
            ...
            <div className={styles.abonaments_block_mobiles}>
              <div
                className={`${styles.abonaments_block_mobile} ${activeMobil_3 == 1 && styles.abonaments_block_mobile_active}`}
                onClick={() => setActiveMobil_3(v => (v === 1 ? 0 : 1))}
              >
                Start 120
              </div>
              <div
                className={`${styles.abonaments_block_mobile} ${activeMobil_3 == 2 && styles.abonaments_block_mobile_active}`}
                onClick={() => setActiveMobil_3(v => (v === 2 ? 0 : 2))}
              >
                Flex 150
              </div>
              <div
                className={`${styles.abonaments_block_mobile} ${activeMobil_3 == 3 && styles.abonaments_block_mobile_active}`}
                onClick={() => setActiveMobil_3(v => (v === 3 ? 0 : 3))}
              >
                Liberty 200
              </div>
              <div
                className={`${styles.abonaments_block_mobile} ${activeMobil_3 == 4 && styles.abonaments_block_mobile_active}`}
                onClick={() => setActiveMobil_3(v => (v === 4 ? 0 : 4))}
              >
                Liberty 290+
              </div>
            </div>
        ...
        <div className={styles.abonaments_block}>
          <div className={styles.abonaments_block_inside}>
            ...
            <div className={styles.abonaments_block_mobiles}>
              <div
                className={`${styles.abonaments_block_mobile} ${activeMobil_4 == 1 && styles.abonaments_block_mobile_active}`}
                onClick={() => setActiveMobil_4(v => (v === 1 ? 0 : 1))}
              >
                Start 120
              </div>
              <div
                className={`${styles.abonaments_block_mobile} ${activeMobil_4 == 2 && styles.abonaments_block_mobile_active}`}
                onClick={() => setActiveMobil_4(v => (v === 2 ? 0 : 2))}
              >
                Flex 150
              </div>
              <div
                className={`${styles.abonaments_block_mobile} ${activeMobil_4 == 3 && styles.abonaments_block_mobile_active}`}
                onClick={() => setActiveMobil_4(v => (v === 3 ? 0 : 3))}
              >
                Liberty 200
              </div>
              <div
                className={`${styles.abonaments_block_mobile} ${activeMobil_4 == 4 && styles.abonaments_block_mobile_active}`}
                onClick={() => setActiveMobil_4(v => (v === 4 ? 0 : 4))}
              >
                Liberty 290+
              </div>
            </div>
        ...
        <div className={styles.abonaments_block}>
          <div className={styles.abonaments_block_inside}>
            ...
            <div className={styles.abonaments_block_mobiles}>
              <div
                className={`${styles.abonaments_block_mobile} ${activeMobil_5 == 1 && styles.abonaments_block_mobile_active}`}
                onClick={() => setActiveMobil_5(v => (v === 1 ? 0 : 1))}
              >
                Start 120
              </div>
              <div
                className={`${styles.abonaments_block_mobile} ${activeMobil_5 == 2 && styles.abonaments_block_mobile_active}`}
                onClick={() => setActiveMobil_5(v => (v === 2 ? 0 : 2))}
              >
                Flex 150
              </div>
              <div
                className={`${styles.abonaments_block_mobile} ${activeMobil_5 == 3 && styles.abonaments_block_mobile_active}`}
                onClick={() => setActiveMobil_5(v => (v === 3 ? 0 : 3))}
              >
                Liberty 200
              </div>
              <div
                className={`${styles.abonaments_block_mobile} ${activeMobil_5 == 4 && styles.abonaments_block_mobile_active}`}
                onClick={() => setActiveMobil_5(v => (v === 4 ? 0 : 4))}
              >
                Liberty 290+
              </div>
            </div>
        ...
        <ScrollableWrapper>
          ...
          >
            <tbody>
              ...
              <tr>
                <td className={styles.popup_table_double_title_table}>Preț</td>
                <td className={styles.popup_table_double_title_table}>
                  80 lei
                </td>
                <td className={styles.popup_table_double_title_table}>
